...
try:
    ...
    filtered_df.to_sql(schema='bdia_team7_db', name='gaia_metadata_tbl_pdf', con=engine, if_exists='replace', index=False)
...
alter_table_query = """
ALTER TABLE bdia_team7_db.gaia_metadata_tbl_pdf
...
try:
    ...
    if connection.is_connected():
        ...
        select_query = "SELECT * FROM bdia_team7_db.gaia_metadata_tbl_pdf"
        cursor.execute(select_query)
        records = cursor.fetchall()
        logging_module.log_success(f"Fetched records from bdia_team7_db.gaia_metadata_tbl_pdf.")
        ...
        for record in records:
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    try:
                        update_s3url_query = """UPDATE bdia_team7_db.gaia_metadata_tbl_pdf
                                                SET s3_url = %s
                                                WHERE task_id = %s"""
                    ...
                    try:
                        update_file_ext_query = """
                            UPDATE bdia_team7_db.gaia_metadata_tbl_pdf
